...
**pre2 build result:** run [27451414651](https://github.com/The412Banner/BannerHub/actions/runs/27451414651) ✅ on `dae0bc15` (tag `v3.8.0-pre2`). Artifact `BannerHub-pre-v3.8.0-pre2` → `BannerHub-v3.8.0-pre2-Normal.apk` (144,843,715 B, md5 `372cbbb81464f337b7884db621ea35ec`) delivered to `/storage/emulated/0/Download/`. Awaiting device retest (expect `BhAudio: sinkLine: gameId=<id> recordingMode=true` in :wine logcat + audible screen recording).
